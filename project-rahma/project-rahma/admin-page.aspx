  ...
  <div class="container-fluid">
    ...
    <form class="d-flex" role="search" >
       <a href ="home-page.aspx"style="text-decoration:none;color: #126266; background-color:aliceblue;margin-right:42px; font-size:large;font-weight:bold; " class="hover"  >Home</a>
                 <a href ="loginpage.aspx"style="text-decoration:none;color: #126266; background-color:aliceblue;margin-right:42px; font-size:large;font-weight:bold; " class="hover"  >Login</a>
    ...
    <div style="display:inline-block; margin-left:5%">
        ...
        <br />
        <asp:Label ID="Label1"   class="hyperlink" runat="server" Text="Label"></asp:Label>
        <br />
                <asp:Label ID="Label2"   class="hyperlink" runat="server" Text="Label"></asp:Label>
    </div>
</div>
