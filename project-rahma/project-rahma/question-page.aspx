  ...
  <div class="container-fluid">
    ...
    <form class="d-flex" role="search" >
         <a href ="home-page.aspx"style="text-decoration:none;color: #126266; background-color:aliceblue;margin-right:42px; font-size:large;font-weight:bold; " class="hover"  >Home</a>
              <a href="home-page.aspx" style="text-decoration:none;color: #126266; background-color:aliceblue;margin-right:42px; font-size:large;font-weight:bold; " class=""  > logout </a>
          ...
          <%-- question 10--%>
           <div class="question-box">
            ...
            <asp:Button ID="Button41" runat="server" Text="Submit" class="submit-button" OnClick="Button41_Click" />
             <asp:Label ID="Label23" runat="server" Text="You should answer all Questions" ForeColor="Red" Visible="False"></asp:Label>
